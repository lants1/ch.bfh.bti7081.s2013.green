...
public class TerminEintragGuiHandler extends CustomComponent {
	...
	public HashMap<Integer, TerminEintrag> eintraege = new HashMap<>();
	...
	public boolean addTermin(TerminEintrag termin) {
		Integer pos = (Integer)table_termine.addItem(new Object[] { termin.getPatient().getFirstName() + " " + termin.getPatient().getFirstName(), "10:00"}, null);
		return true;
	}
	
	public void DateChanged(Date newDate) {
		table_termine.removeAllItems();
...
//			table_termine.addItem(new Object[] { "Pascal von OW",termin.getBeschreibung()}, i);
//			i += 1;
//		}
		
		table_termine.addItem(new Object[] { "Pascal von OW", "10:00"}, 1);
		table_termine.addItem(new Object[] { "Pascal Bohni", "11:30"}, 2);
	}
