...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.DateField","com.vaadin.ui.BrowserFrame","com.vaadin.ui.TextArea","com.vaadin.ui.Accordion","com.vaadin.ui.GridLayout","com.vaadin.ui.Upload","com.vaadin.ui.Image","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Button","com.vaadin.ui.Window","com.vaadin.ui.PasswordField","com.vaadin.ui.TreeTable","com.vaadin.ui.VerticalLayout","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.Video","com.vaadin.ui.CssLayout","com.vaadin.ui.Audio","com.vaadin.server.FileDownloader","com.vaadin.ui.ListSelect","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.UI","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.MenuBar","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.FormLayout","com.vaadin.ui.ComboBox","com.vaadin.ui.Tree","com.vaadin.ui.NativeSelect","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.PopupView","com.vaadin.ui.Embedded","com.vaadin.ui.CustomComponent","com.vaadin.ui.TextField","com.vaadin.ui.Panel","com.vaadin.ui.TabSheet","com.vaadin.ui.Slider","com.vaadin.ui.CheckBox","com.vaadin.ui.Flash","com.vaadin.ui.OptionGroup","com.vaadin.ui.Form","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.CustomLayout","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Link","com.vaadin.ui.NativeButton","com.vaadin.ui.InlineDateField","com.vaadin.ui.Table","com.vaadin.ui.CustomField","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.JavaScript","com.vaadin.ui.Label","com.vaadin.ui.TwinColSelect",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"height", "caption", "description", "immediate", "primaryStyleName", "styles", "registeredEventListeners", "errorMessage", "resources", "readOnly", "enabled", "id", "width", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"required", "styles", "errorMessage", "tabIndex", "primaryStyleName", "description", "modified", "id", "height", "resources", "enabled", "immediate", "registeredEventListeners", "caption", "propertyReadOnly", "readOnly", "width", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"styles", "caption", "primaryStyleName", "resources", "contentMode", "errorMessage", "id", "height", "width", "enabled", "text", "registeredEventListeners", "readOnly", "immediate", "description", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"propertyReadOnly", "readOnly", "width", "primaryStyleName", "immediate", "height", "modified", "hideErrors", "enabled", "errorMessage", "description", "registeredEventListeners", "tabIndex", "styles", "required", "resources", "id", "caption", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"errorMessage", "registeredEventListeners", "resources", "readOnly", "immediate", "description", "height", "width", "primaryStyleName", "id", "enabled", "secondChild", "splitterState", "caption", "styles", "firstChild", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"immediate", "height", "caption", "errorMessage", "marginsBitmask", "styles", "registeredEventListeners", "readOnly", "enabled", "description", "childData", "resources", "primaryStyleName", "id", "width", "spacing", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"readOnly", "pollingInterval", "indeterminate", "registeredEventListeners", "immediate", "modified", "width", "propertyReadOnly", "required", "primaryStyleName", "caption", "styles", "errorMessage", "resources", "state", "enabled", "hideErrors", "height", "id", "description", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"caption", "spacing", "immediate", "styles", "resources", "childData", "primaryStyleName", "width", "registeredEventListeners", "marginsBitmask", "height", "readOnly", "description", "id", "enabled", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"enabled", "modified", "tabIndex", "readOnly", "propertyReadOnly", "caption", "required", "immediate", "width", "height", "styles", "resources", "id", "hideErrors", "registeredEventListeners", "description", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"width", "height", "registeredEventListeners", "resources", "enabled", "caption", "errorMessage", "id", "description", "readOnly", "primaryStyleName", "styles", "immediate", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"styles", "primaryStyleName", "readOnly", "description", "width", "height", "resources", "spacing", "immediate", "childData", "caption", "id", "enabled", "errorMessage", "registeredEventListeners", "marginsBitmask", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"caption", "enabled", "textFieldEnabled", "tabIndex", "readOnly", "id", "registeredEventListeners", "description", "primaryStyleName", "immediate", "errorMessage", "height", "styles", "width", "modified", "required", "hideErrors", "resources", "propertyReadOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"registeredEventListeners", "primaryStyleName", "errorMessage", "description", "styles", "immediate", "connectorToCssPosition", "resources", "caption", "readOnly", "width", "id", "height", "enabled", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"names", "resources", "registeredEventListeners", "enabled", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"enabled", "immediate", "readOnly", "id", "height", "resources", "styles", "primaryStyleName", "description", "caption", "alternateText", "width", "registeredEventListeners", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"enabled", "codetype", "description", "codebase", "height", "standby", "primaryStyleName", "alternateText", "errorMessage", "embedParams", "caption", "classId", "width", "immediate", "archive", "registeredEventListeners", "styles", "resources", "id", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"readOnly", "id", "immediate", "styles", "width", "errorMessage", "description", "registeredEventListeners", "caption", "height", "enabled", "primaryStyleName", "resources", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"modified", "id", "registeredEventListeners", "propertyReadOnly", "caption", "hideErrors", "styles", "height", "width", "readOnly", "enabled", "required", "immediate", "description", "tabIndex", "resources", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"resources", "rpcInterfaces", "enabled", "registeredEventListeners", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"primaryStyleName", "styles", "hideErrors", "required", "height", "id", "registeredEventListeners", "enabled", "readOnly", "description", "propertyReadOnly", "tabIndex", "resources", "checked", "immediate", "modified", "errorMessage", "caption", "width", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"registeredEventListeners", "width", "enabled", "resources", "primaryStyleName", "caption", "errorMessage", "splitterState", "description", "styles", "secondChild", "immediate", "id", "firstChild", "height", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"errorMessage", "enabled", "readOnly", "description", "id", "resources", "width", "caption", "html", "hideOnMouseOut", "height", "primaryStyleName", "immediate", "styles", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"primaryStyleName", "childCss", "caption", "id", "immediate", "registeredEventListeners", "height", "width", "styles", "enabled", "readOnly", "description", "errorMessage", "resources", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"height", "width", "caption", "enabled", "registeredEventListeners", "primaryStyleName", "errorMessage", "id", "readOnly", "styles", "description", "immediate", "resources", });
            store.setProperties(com.vaadin.shared.communication.SharedState.class, new String[] {"registeredEventListeners", "enabled", "resources", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"required", "width", "propertyReadOnly", "tabIndex", "hideErrors", "modified", "immediate", "resources", "description", "enabled", "height", "id", "errorMessage", "caption", "readOnly", "primaryStyleName", "styles", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"immediate", "styles", "maxValue", "height", "hideErrors", "primaryStyleName", "required", "modified", "tabIndex", "id", "orientation", "registeredEventListeners", "resources", "width", "resolution", "propertyReadOnly", "enabled", "minValue", "readOnly", "errorMessage", "value", "description", "caption", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"required", "width", "propertyReadOnly", "registeredEventListeners", "description", "hideErrors", "caption", "styles", "resources", "modified", "errorMessage", "height", "readOnly", "id", "tabIndex", "immediate", "primaryStyleName", "enabled", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"registeredEventListeners", "resizeLazy", "draggable", "height", "scrollLeft", "primaryStyleName", "centered", "errorMessage", "caption", "styles", "scrollTop", "enabled", "description", "resources", "width", "readOnly", "id", "immediate", "modal", "resizable", "positionX", "tabIndex", "positionY", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"primaryStyleName", "htmlContentAllowed", "clickShortcutKeyCode", "registeredEventListeners", "tabIndex", "styles", "enabled", "immediate", "caption", "readOnly", "description", "id", "width", "disableOnClick", "resources", "errorMessage", "height", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"id", "readOnly", "htmlContentAllowed", "enabled", "height", "caption", "resources", "clickShortcutKeyCode", "immediate", "primaryStyleName", "styles", "tabIndex", "description", "width", "errorMessage", "disableOnClick", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"tabIndex", "readOnly", "primaryStyleName", "height", "immediate", "hideErrors", "enabled", "text", "registeredEventListeners", "inputPrompt", "styles", "caption", "modified", "required", "columns", "id", "errorMessage", "description", "propertyReadOnly", "resources", "maxLength", "width", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"errorMessage", "description", "width", "maxLength", "immediate", "resources", "inputPrompt", "primaryStyleName", "enabled", "readOnly", "tabIndex", "wordwrap", "rows", "registeredEventListeners", "id", "height", "propertyReadOnly", "modified", "styles", "columns", "text", "required", "caption", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"styles", "registeredEventListeners", "description", "alternateText", "caption", "enabled", "height", "immediate", "id", "resources", "width", "primaryStyleName", "readOnly", "errorMessage", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"registeredEventListeners", "caption", "resources", "width", "required", "height", "propertyReadOnly", "modified", "errorMessage", "readOnly", "immediate", "description", "tabIndex", "styles", "enabled", "primaryStyleName", "id", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"childData", "primaryStyleName", "marginsBitmask", "id", "immediate", "errorMessage", "readOnly", "description", "caption", "styles", "columns", "rows", "width", "resources", "registeredEventListeners", "enabled", "spacing", "height", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"rpcInterfaces", "callbackNames", "errorMessage", "width", "readOnly", "height", "id", "registeredEventListeners", "enabled", "styles", "description", "primaryStyleName", "resources", "immediate", "caption", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"scrollLeft", "resources", "width", "description", "readOnly", "registeredEventListeners", "caption", "id", "styles", "primaryStyleName", "tabIndex", "errorMessage", "immediate", "enabled", "height", "scrollTop", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"registeredEventListeners", "description", "primaryStyleName", "resources", "sources", "immediate", "errorMessage", "showControls", "htmlContentAllowed", "width", "altText", "muted", "enabled", "height", "autoplay", "id", "styles", "caption", "readOnly", "sourceTypes", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"immediate", "description", "layout", "hideErrors", "primaryStyleName", "id", "required", "propertyReadOnly", "width", "styles", "enabled", "footer", "modified", "readOnly", "errorMessage", "height", "resources", "caption", "tabIndex", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"alternateText", "caption", "resources", "styles", "width", "id", "errorMessage", "height", "immediate", "registeredEventListeners", "enabled", "readOnly", "primaryStyleName", "description", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"enabled", "readOnly", "propertyReadOnly", "primaryStyleName", "immediate", "height", "styles", "caption", "registeredEventListeners", "description", "required", "errorMessage", "hideErrors", "width", "id", "modified", "resources", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"registeredEventListeners", "styles", "autoplay", "showControls", "height", "readOnly", "width", "primaryStyleName", "sources", "enabled", "errorMessage", "caption", "id", "immediate", "resources", "altText", "muted", "htmlContentAllowed", "description", "sourceTypes", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"width", "height", "readOnly", "errorMessage", "caption", "styles", "id", "enabled", "registeredEventListeners", "resources", "primaryStyleName", "description", "immediate", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"relativeY", "relativeX", "type", "ctrlKey", "shiftKey", "metaKey", "clientX", "clientY", "button", "altKey", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"registeredEventListeners", "width", "enabled", "primaryStyleName", "templateContents", "resources", "height", "readOnly", "errorMessage", "caption", "immediate", "description", "styles", "templateName", "id", "childLocations", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"id", "registeredEventListeners", "errorMessage", "height", "resources", "caption", "features", "parameters", "styles", "target", "description", "immediate", "width", "readOnly", "primaryStyleName", "uriFragment", "enabled", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "row1", "row2", "column2", "column1", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionReversed", "minPositionUnit", "minPosition", "position", "positionUnit", "maxPositionUnit", "locked", "maxPosition", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"readOnly", "primaryStyleName", "width", "caption", "registeredEventListeners", "height", "enabled", "immediate", "description", "cursorX", "id", "cursorY", "bgColor", "resources", "errorMessage", "styles", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"description", "resources", "htmlContentAllowed", "styles", "errorMessage", "registeredEventListeners", "readOnly", "immediate", "popupVisible", "width", "primaryStyleName", "height", "showDefaultCaption", "id", "enabled", "color", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"primaryStyleName", "readOnly", "rowCount", "changedColor", "caption", "registeredEventListeners", "id", "height", "resources", "errorMessage", "description", "changedY", "enabled", "changedX", "width", "columnCount", "styles", "immediate", });
